...
const ProdImgBox = () => {
  return (
    <section className='prodimgboxes'>
       <div className="allprodimgboxes row">
        <div className="prodimgbox col-lg-4 col-12">
            <div className="prodimgtext"><h3>Subscribe & Save 10% off every order.</h3></div>
        ...
        <div className="prodimgbox col-lg-4 col-12">
            <div className="prodimgtext"><h3 className='white'>Real deal ingredients in every flavor.</h3></div>
        ...
        <div className="prodimgbox col-lg-4 col-12">
            <div className="prodimgtext"><h3>Free shipping on orders over $39.</h3></div>
