...
const Terms = () => {
  return (
    <div className="terms">
      <div className="allterms col-lg-6 m-auto">
        ...
        <div className="termstext">
            ...
            <p>
              <span>
                ...
                to our Return Policy below:
              </span>
            </p>
            <div>
              Defective products purchased from&nbsp;
              <a
                href="http://partakefoods.com/"
                target="_blank"
                data-saferedirecturl="https://www.google.com/url?q=http://partakefoods.com/&amp;source=gmail&amp;ust=1600792200234000&amp;usg=AFQjCNHysEe1c1eh3-tRJmjtmtBe7orO4Q"
                rel="noopener noreferrer"
                aria-label="partakefoods.com - Opens in a new tab "
              >
                partakefoods.com
              </a>
              :
            ...
            <div>
              To inquire about a refund on defective products purchased from
              Partake's website, please&nbsp;contact us [hyperlink to contact
              page]. Products are deemed defective at Partake's discretion. If
              the products are deemed defective, they can&nbsp;be refunded at
              partial or full refund to the credit card on file. If purchased
              with a gift card, a new gift card will&nbsp;be provided. Please
              note that minor damage to packaging is not considered defective.
            </div>
            <div></div>
            <div>Defective products purchased from another retailer:&nbsp;</div>
            <div>
              All products thought to be defective purchased from a retailer
              must be returned to the retailer for replacement or refund.
              Partake cannot issue partial or full refunds for defective
              products not purchased through Partake's website.
            </div>
            <div></div>
            <div>Non-defective products:</div>
            <div>There is a no refund policy on non-defective products.</div>
            <p>
              <span>
            ...
            <p>
              <span>
                You agree to indemnify, defend and hold harmless Partake Foods
            ...
            <p>
              <span>
                ...
                accordance with the laws of 115 w 18th st, 2nd floor New York
                New York US 10011.
              </span>
            </p>
            <p>
